...
$("#btnLeast").click(function () {
    ...
    if (isNaN(least) == true) {
        $(this).next().replaceWith("<p class='blue-font'>Oops. Every box must contain a valid number. Try again!</p>");
    } else {
        //display lowest number
        $(this).next().replaceWith("<p class='blue-font'><span class='light-blue-font'>" + least + "</span> is the lowest number</p>");
    }
});
...
$("#btnGreatest").click(function () {
    ...
    if (isNaN(greatest) == true) {
        ...
        $(this).next().replaceWith("<p class='blue-font'><span class='light-blue-font'>" + greatest + "</span> is the highest number</p>");
    }
});
...
$("#btnAvg").click(function () {
    ...
    if (isNaN(avg) == true) {
        ...
        //display the average
        $(this).next().replaceWith("<p class='blue-font'><span class='light-blue-font'>" + avg + "</span> is the average of the set of numbers</p>");
    }
});
...
$("#btnSum").click(function () {
    ...
    if (isNaN(sum) == true) {
        ...
        //display the sum
        $(this).next().replaceWith("<p class='blue-font'><span class='light-blue-font'>" + sum + "</span> is the sum of the set of numbers</p>");
    }
});
...
$("#btnProduct").click(function () {
    ...
    if (isNaN(product) == true) {
        ...
        //display the product
        $(this).next().replaceWith("<p class='blue-font'><span class='light-blue-font'>" + product + "</span> is the product of the set of numbers</p>");
    }
});
...
$("#calcFactorial").click(function () {
    ...
    if (isNaN(userFactorial) == true) {
        $(this).next().replaceWith("<p class='blue-font'>You must enter a valid numeric value. Try again.</p>");
    } else if (userFactorial < 1 || userFactorial > 199) {
        $(this).next().replaceWith("<p class='blue-font'>Please enter numeric values between 1 and 199.</p>");
    } else if (userFactorial % 1 !== 0) {
        $(this).next().replaceWith("<p class='blue-font'>Please enter only integers. Try again.</p>");
    } else {
        //display the resulting factorial product
        $(this).next().replaceWith("<p class='blue-font'>Answer: <span class='light-blue-font'>" + userFactorial + " Factorial (or " + userFactorial + "!) is " + factorial + "</span>");
    }
});
...
$("#runMultiples").click(function runMultiples() {
    ...
    if (isNaN(m1) == true || isNaN(m2) == true) {
        $("#numberContainer").append("<p class='blue-font'>You must enter two valid numeric values. Try again.</p>");
    } else if (m1 < 2 || m1 > 99 || m2 < 2 || m2 > 99) {
        $("#numberContainer").append("<p class='blue-font'>Both numbers must be between 2 and 99. Try again!</p>");
    } else {
        ...
        for (var c = 1; c <= 100; ++c) {
            ...
            if (c % m1 === 0 && c % m2 === 0) {
                ...
                $("#numberContainer").append("<span class= 'light-blue-font'>   FIZZBUZZ </span>  ");
                //else if remainder of counter divided by m1 equals 0
            } else if (c % m1 === 0) {
                //then display "fizz"
                $("#numberContainer").append("<span class= 'light-blue-font'>    Fizz </span>   ");
                //else if remainder of counter divided by m2 equals 0
            } else if (c % m2 === 0) {
                //then display "buzz"  
                $("#numberContainer").append("<span class= 'light-blue-font'>    Buzz </span>   ");
...
$("#checkPalindrome").click(function () {
    ...
    if (userWord == "") {
        $(this).next().replaceWith("<p class='blue-font'>You must first enter a word, phrase or sequence. Try Again.</p>");
    } else if (userWord.length < 3) {
        $(this).next().replaceWith("<p class='blue-font'>C'mon now, make it interesting! Try at least two characters.</p>");
    } else if (userWord.toLowerCase() === reverseWord.toLowerCase()) {
        //display YES PALINDROME message
        $(this).next().replaceWith("<p class='blue-font'><span class='light-blue-font'>" + userWord + "</span> is a palindrome! Cool!</p>");
        //else display NO PALINDROME message 
    } else {
        $(this).next().replaceWith("<p class='blue-font'><span class='light-blue-font'>" + userWord + "</span> is not a palindrome because it's different when read backward. (" + reverseWord + ")</p>");
    }
});